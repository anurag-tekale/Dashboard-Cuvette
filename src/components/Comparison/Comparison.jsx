      ...
      external: function(context) {
        ...
        if (tooltipModel.body) {
            ...
            titleLines.forEach(function(title) {
                innerHtml += '<p class="chart-body__ttl">' + title + ' Percentile</p>';
            });
    ...
    datasets: [
      {
        ...
        segment: {
          borderColor: ctx => {
            let percentileIndex = ctx.chart.data.labels.indexOf(`${percentile}%`);
            if(ctx.p0.parsed.x === percentileIndex || ctx.p0.parsed.x === percentileIndex - 1) {
              return '#438AF6';
            }
            return '#C8D6E5';
          },
        ...
        pointStyle: ctx => {
          let percentileIndex = ctx.chart.data.labels.indexOf(`${percentile}%`);
          if(ctx.parsed.x === percentileIndex || ctx.parsed.x === percentileIndex - 1) {
            return 'none';
          }
          return 'none';
        },
  ...
  return (
    <div className="comparison container">
      ...
      <div className="comparison__txt">
        <p><b>You scored {percentile}% percentile</b> which is lower than the <br />average percentile 72% of all the engineers who took this assessment</p>
      ...
      <div className="comparison__big-chart">
        ...
        <div className="chart-bg-1" style={{left: `${(positionOfPercentile -1) * 98 + 47}px`}}></div>
